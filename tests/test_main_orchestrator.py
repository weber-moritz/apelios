...
@pytest.mark.asyncio
async def test_start_sequence_order(mock_broker, mock_router, mock_input, mock_fixture):
...
@pytest.mark.asyncio
async def test_stop_sequence_order(mock_broker, mock_router, mock_input, mock_fixture):
...
@pytest.mark.asyncio
async def test_health_check_fails_if_fixture_down(mock_broker, mock_router, mock_input, mock_fixture):
...
@pytest.mark.asyncio
async def test_run_forever_executes_tick_and_cleans_up(mock_broker, mock_router, mock_input, mock_fixture):
    ...
    # This ensures input and router get their turn to tick before the loop breaks.
